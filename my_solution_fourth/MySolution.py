...
if __name__ == '__main__':
    ...
    def usage():
        print "python MySolution.py NUM_ELVES MAX_PRODUCTIVITY MINUTES_END_OF_DAY"
    ...
    soln_file = os.path.join(os.getcwd(), '..', 'DATA', 'my_solution_fourth_num_elves_%d_prod_%s_minutes_%d.csv' % (NUM_ELVES, PRODUCTIVITY_THRESHOLD_STR, MINUTES_LEFT_END_OF_DAY))
